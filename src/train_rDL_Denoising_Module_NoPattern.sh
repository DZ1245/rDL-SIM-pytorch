...
python  -m torch.distributed.launch --nproc_per_node 1 --master_port 29271 \
                                    ...
                                    --num_gpu 1 --num_workers 3 --norm_flag 1 --load_weights_flag 0 \
                                    --exp_name rDL_PKUse_NoPattern_onlyPFEv2 \
                                    --resume_name rDL_PKUse_NoPattern_onlyPFEv2 \
                                    --SR_resume_name DFCAN_PKU_separate \
                                    --batch_size 1 --MPE_input_channel 3 \
